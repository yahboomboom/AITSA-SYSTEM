export default function AdmissionPipeline({ pipeline, agreementsSigned }) {
    return (
        <div className="bg-white dark:bg-panelDark border border-brandNavy/10 dark:border-slate-800 rounded-lg shadow-sm overflow-hidden">
            ...
            <div className="grid grid-cols-2 gap-px bg-brandNavy/8 dark:bg-slate-700">
                ...
                <div className="p-5 text-center space-y-1 bg-white dark:bg-panelDark">
                    <p className="text-xs text-brandNavy/40 dark:text-slate-500">Active students</p>
                    <p className="font-heading text-2xl font-semibold text-brandGreen">{pipeline.totalStudents}</p>
                    <p className="text-xs text-brandNavy/40 dark:text-slate-500">Total accounts, all terms.</p>
                </div>
                <div className="p-5 text-center space-y-1 bg-white dark:bg-panelDark">
                    <p className="text-xs text-brandNavy/40 dark:text-slate-500">Agreements signed</p>
                    <p className="font-heading text-2xl font-semibold text-brandGold">{agreementsSigned}</p>
                    <p className="text-xs text-brandNavy/40 dark:text-slate-500">Enrollment agreements.</p>
                </div>
            </div>
        </div>
    );
