...
export default function ReportTable({ rows, csrfToken, schoolYear }) {
                    ...
                    <table className="ui-table">
                        <thead>
                            <tr className="border-brandNavy/8 dark:border-slate-800 text-brandNavy/50 dark:text-slate-500">
                                ...
                                <th className="border-brandNavy/8 dark:border-slate-800 text-center no-print">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            {filtered.length === 0 && (
                                <tr>
                                    <td colSpan={9} className="border-brandNavy/8 dark:border-slate-800 py-10 text-center text-brandNavy/40 dark:text-slate-500">
                                        {!search.trim() && status === 'all' ? 'Search to view clearance records.' : 'No matching records.'}
                                    </td>
                                </tr>
                            )}
                            {filtered.map((r, i) => (
                                <tr key={r.id}>
                                    ...
                                    <td className="border-brandNavy/8 dark:border-slate-800 text-center no-print">
                                        {!r.registrarSigned ? (
                                            ...
                                            <span className="text-xs font-medium text-brandGreen/70">
