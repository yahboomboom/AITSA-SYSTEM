...
// Applies broadly to every plain text/email input on this form — walk-in
// registration data should be typed by whoever is entering it, not pasted
...
export default function CreateStudentForm({ applicant, programs, old, csrfToken, actionUrl }) {
    ...
    const [contactNumber, setContactNumber] = useState(old.contact_number ?? applicant?.contactNumber ?? '');
                    ...
                    <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    value={password} onChange={(e) => setPassword(e.target.value)} onPaste={blockPaste}
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <input
                                ...
                                value={passwordConfirmation} onChange={(e) => setPasswordConfirmation(e.target.value)} onPaste={blockPaste}
                                className={`${inputClass} font-mono`}
                            />
                        </div>
                    </div>
                ...
                <div className="bg-white dark:bg-panelDark border border-brandNavy/10 dark:border-slate-800 rounded-lg shadow-sm overflow-hidden">
                    ...
                    <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input
                                type="text" name="section" defaultValue={old.section} placeholder="e.g. BSOA-1A" onPaste={blockPaste}
                                className={inputClass}
                            />
                        </div>
                        <div>
                    ...
                    <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
                        {applicant ? (
                            <div className="sm:col-span-2">
                                ...
                                <input
                                    type="text" name="name" defaultValue={applicant.name} required
                                    readOnly
                            ...
                            <>
                                <div>
                                    ...
                                    <input
                                        type="text" name="last_name" defaultValue={old.last_name ?? ''} required
                                        placeholder="Dela Cruz" onPaste={blockPaste}
                                        className={inputClass}
                                    />
                                </div>
                                <div>
                                    ...
                                    <input
                                        type="text" name="first_name" defaultValue={old.first_name ?? ''} required
                                        placeholder="Juan" onPaste={blockPaste}
                                        className={inputClass}
                                    />
                                </div>
                                <div>
                                    <label className={labelClass}>Middle name <span className="text-brandNavy/30 dark:text-slate-600 font-normal">(optional)</span></label>
                                    <input
                                        type="text" name="middle_name" defaultValue={old.middle_name ?? ''}
                                        placeholder="Santos" onPaste={blockPaste}
                                        className={inputClass}
                                    />
                                </div>
                            </>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="student@email.com" readOnly={!!applicant} onPaste={blockPaste}
                        ...
                        <div>
                            ...
                            <input
                                type="text" inputMode="numeric" name="contact_number" placeholder="09XXXXXXXXX"
                                value={contactNumber} onChange={(e) => setContactNumber(e.target.value.replace(/[^0-9]/g, ''))} onPaste={blockPaste}
                                className={inputClass}
                            />
                        </div>
                        <div>
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <input
                                type="text" name="address" defaultValue={old.address ?? applicant?.address ?? ''} placeholder="Street, Barangay, City/Municipality, Province" onPaste={blockPaste}
                                className={inputClass}
                            />
                        </div>
                    </div>
