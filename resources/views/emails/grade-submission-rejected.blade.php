...
<head>
    <meta charset="UTF-8">
    <title>Grade Submission Returned</title>
</head>
<body style="margin:0; padding:0; background-color:#f4f5f7; font-family: Arial, Helvetica, sans-serif; color:#0B3C5D;">
    <div style="max-width:480px; margin:0 auto; padding:32px 24px;">
        ...
        <div style="background:#ffffff; border-radius:0 0 12px 12px; padding:28px 24px; border:1px solid #e5e7eb; border-top:none;">
            <p style="font-size:14px;">Hi {{ $faculty->name }},</p>

            <p style="font-size:14px; line-height:1.6;">
                The <strong>{{ $office }}</strong> has returned your grade submission for
                <strong>{{ $subjectCode }} (Block {{ $blockLabel }})</strong> and needs a correction before it can proceed.
            </p>
            ...
            <p style="font-size:13px; line-height:1.6; color:#4b5563;">
                Log in to the AitsaGate Portal to update and resubmit the grades.
            </p>

            <p style="font-size:13px; margin-top:24px;">— AITSA Office of the Registrar</p>
        </div>
    </div>
</body>
</html>
