    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/js/approver-curriculum-app.jsx',
                ...
                'resources/js/registrar-documents-app.jsx',
                'resources/js/registrar-reports-app.jsx',
                'resources/js/registrar-slots-app.jsx',
                'resources/js/faculty-sections-app.jsx',
                'resources/js/section-grades-app.jsx',
