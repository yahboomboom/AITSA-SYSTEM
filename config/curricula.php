...
return [
    ['id' => 'bk3',    'name' => 'Bookkeeping NC III',                            'level' => 'TESDA',     'icon' => 'fa-book-bookmark',      'duration' => '6 months'],
    ['id' => 'em3',    'name' => 'Events Management NC III',                       'level' => 'TESDA',     'icon' => 'fa-calendar-star',      'duration' => '6 months'],
    ['id' => 'fb3',    'name' => 'Food & Beverages NC III',                        'level' => 'TESDA',     'icon' => 'fa-utensils',           'duration' => '6 months'],
